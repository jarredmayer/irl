      ...
      for (const targetDay of showDays) {
        ...
        for (const time of showTimes) {
          events.push({
            ...
            priceAmount: 35,
            isOutdoor: false,
            description: 'Live stand-up comedy featuring touring comedians and local favorites. 21+ with two-drink minimum.',
      ...
      for (const targetDay of showDays) {
        ...
        for (const time of showTimes) {
          events.push({
            ...
            address: '1100 Silks Run #1490, Dania Beach, FL 33004',
